  ...
  return (
    <>
      ...
      {/* <div className="dropdown">
        <label tabIndex={0} className="btn btn-ghost btn-sm m-1 rounded-full">
          {theme === "dark" ? <BsFillMoonFill /> : <BsFillSunFill />}
        </label>
        <ul
          tabIndex={0}
          className="menu dropdown-content z-[2] max-h-[20rem] w-fit rounded-box bg-base-100 p-2 shadow"
        >
          {themes.map((theme) => (
